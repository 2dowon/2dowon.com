...
date: "2025-02-07"
summary: "Next.js App Router의 Parallel Routes, Intercepting Routes를 사용해 더 좋은 모달창을 띄우기"
thumbnail: "https://github.com/2dowon/2dowon.com/blob/main/public/static/images/post/writing/open-good-modal-using-parallel-routes-and-intercepting-routes-cover.png?raw=true"
---
...
![](/static/images/post/writing/open-good-modal-using-parallel-routes-and-intercepting-routes-1.png)
...
![](/static/images/post/writing/open-good-modal-using-parallel-routes-and-intercepting-routes-2.png)
...
![](/static/images/post/writing/open-good-modal-using-parallel-routes-and-intercepting-routes-3.gif)
![](/static/images/post/writing/open-good-modal-using-parallel-routes-and-intercepting-routes-4.png)
